    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/ilyashn972/helpdementiaperson/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/ilyashn972/helpdementiaperson.git")
                    developerConnection.set("scm:git:ssh://github.com/ilyashn972/helpdementiaperson.git")
                    url.set("https://github.com/ilyashn972/helpdementiaperson/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/ilyashn972/helpdementiaperson/issues")
                }
            }
        }
    }
